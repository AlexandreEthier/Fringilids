...
## [Jeux de données]{style="color: yellow;"}
...
## [Code pour la tendance temporelle de l'abondance des Fringillidés]{style="color: yellow;"}
...
load("/Users/maxencepoirier-joanette/Rstudio/FOR7046/Fringilids/Data/DUSA_output_prop.R")
load("/Users/maxencepoirier-joanette/Rstudio/FOR7046/Fringilids/Data/JABO_output_prop.R")
load("/Users/maxencepoirier-joanette/Rstudio/FOR7046/Fringilids/Data/SIFL_output_prop.R")
load("/Users/maxencepoirier-joanette/Rstudio/FOR7046/Fringilids/Data/TAPI_output_prop.R")
...
[La condition est régie par des processus morphologiques qui évolue peu dans le temps]{style="color: yellow;"}
...
a)  Est-ce que la proportion de jeunes de l’année (indice de succès reproducteur) est corrélée avec les irruptions ?

. . .

b)  Est-ce que la condition corporelle est corrélée à l'irruption ?
...
#| echo: true
#| eval: true
#| code-line-numbers: "|3-13|15-17|19-28|30-44|54-55|57-64|68-71|74|76-83|86"
...
## [Effets des irruptions par espèce sur la proporon]{style="color: yellow;"}
...
plot(axex, tab_comp_JAGS$mean,
      xaxt = "n",
      ylim = range(c(tab_comp_JAGS$ic_inf, tab_comp_JAGS$ic_sup)),
      ylab = "Effet de l'irruption (beta_irru)",
      xlab = "Espèces",
      pch = 16,
      main = "Effet des irruptions sur la proportion")
...
boxplot(TAPI_bague$condition[TAPI_bague$TAPI_IRR=="0"],
        ...
        names = c("Non irruption", "Irruption"))
```
## [Visualisation]{style="color: yellow;"}
...
[Pour la condition, c'est très peu concluant]{style="color: yellow;"}
. . .
