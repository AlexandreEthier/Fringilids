...
## [Modèle linéaire JABO]{style="color: yellow;"}
...
## [Modèle linéaire SIFL]{style="color: yellow;"}
...
## [Modèle linéaire TAPI]{style="color: yellow;"}
...
## [Code pour IC à 95%]{style="color: yellow;"}
...
## [Figure pour IC à 95% pour l'abondance]{style="color: yellow;"}
...
## [Visualisation pour la visualisation de la condition dans le temps]{style="color: yellow;"}
...
Une irruption d'oiseaux est un mouvement migratoire irrégulier et massif d'espèces (souvent boréales) vers des régions plus méridionales, déclenché par une pénurie soudaine de nourriture (graines, petits rongeurs) sur leurs lieux de reproduction. Contrairement à la migration saisonnière, l'irruption est imprévisible.
...
## [Formule pour définir une irruption]{style="color: yellow;"}
...
## [Comparer les années irruptives vs non-irruptives]{style="color: yellow;"}

Ajouter graph d'Adrien (deux groupes)
