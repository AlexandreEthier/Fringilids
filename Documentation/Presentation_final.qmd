...
## [Tableau IC à 95% pour la proportion de jeunes]{style="color: yellow;"}
```{r}
#| echo: true
#| eval: true
...
## [Code pour la tendance temporelle de la condition des Fringillidés]{style="color: yellow;"}
...
[La condition]{style="color: yellow;"}
